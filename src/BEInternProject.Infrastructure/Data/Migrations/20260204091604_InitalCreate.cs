...
namespace BEInternProject.Infrastructure.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_id = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    updated_id = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tasks", x => x.task_item_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_worklogs", x => x.worklog_id);
                    table.CheckConstraint("ck_worklogs_hours", "hours_spent > 0 AND hours_spent <= 8");
                    table.ForeignKey(
                        name: "FK_worklogs_tasks_task_item_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tasks_assignee_id_deadline",
                table: "tasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_worklogs_task_item_id_user_id_work_date",
                table: "worklogs",
                columns: new[] { "task_item_id", "user_id", "work_date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_worklogs_user_id",
                table: "worklogs",
                column: "user_id");
        }
