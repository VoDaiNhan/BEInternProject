    ...
    public class TaskWorklogDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TaskItem>(t =>
            {
                ...
                t.Property(x => x.CreatedAt).HasColumnName("created_id").HasDefaultValueSql("now()");
                t.Property(x => x.UpdatedAt).HasColumnName("updated_id");
            ...
            modelBuilder.Entity<Worklog>(w =>
            {
                ...
                w.ToTable(x => x.HasCheckConstraint("ck_worklogs_hours", "hours_spent > 0 AND hours_spent <= 8"));
